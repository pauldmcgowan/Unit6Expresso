...
const menuItemsRouter = require('./menusItems.js');
...
menusRouter.delete('/:menuId', (req, res, next) => {
    ...
    const menuItemSql = `SELECT * FROM MenuItem WHERE MenuItem.menu_id = $id`;
    db.get(menuItemSql, id, (error, menuItem) => {
        if (menuItem)
        {
          res.sendStatus(400);
        }
